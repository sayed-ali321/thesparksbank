    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1  class="text-warning" style=" color:white; text-transform: uppercase;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/rohit.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created & Developed by</p>
            <h1 class="" style="color:white; text-size: bold; text-shadow:2px 2px 2px gray;"> Neha Kumari Prasad</h1>
            <p class="text-success" style="color:gray;"><b>Intern at The Sparks Foundation <br> NSHM Knowledge Campus, Durgapur</b></p>
        </center>
